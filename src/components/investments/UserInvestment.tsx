    ...
    <section className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-4">
        {userInvestment.map((investment, index) => {
          const sign = investment.type_of_percentage === 'positive' ? "+" : "-";
          const color = investment.type_of_percentage === 'positive' ? "#16DBAA": "#FE5C73";
          ...
          return (
            <div key={index} className="flex items-center justify-between">
              ...
              <p style={{color: color}}>{sign}{investment.percentage}%</p>
            </div>
          );
        })}
      </div>
