  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-[100vh] w-[--sidebar-width] flex-col text-sidebar-foreground fixed",
            className
          )}
          ref={ref}
          {...props}
